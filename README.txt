...
exemple: # cargo run -- 2 ex.txt y
====> cargo will run the resolution of the table ex.txt with the euclidien distance as the heuristic function and time out if it takes more than 10 seconds
--------------------------------------------------------------------
